...
namespace ShopSolution.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var viewModel = new HomeViewModel
            {
                ...
                LatestProducts = await _productApiClient.GetLatestProducts(culture, SystemConstants.ProductSettings.NumberOfFeaturedProducts),
            };
